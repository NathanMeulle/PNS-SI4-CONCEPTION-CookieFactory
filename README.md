...
| <ul><li>En tant que client anonyme </li><li>Je veux commander un cookie</li><li>Afin de réserver mes cookies </li></ul> | IntegrationOrdering.feature | <ul><li>Anonymous makes an order</li><li>Anonymous can't make an order because out of stock</li></ul> |
...
| <ul><li>En tant que client</li><li>Je veux récupérer ma commande</li><li>Afin d'obtenir mes cookies </li></ul>| PickUpOrderfeature | <ul><li>pick up an order already cooked</li><li>can't pick up if not paid</li><li>pick up an order not cooked yet</li><li>scenario4</li></ul> |
...
| <ul><li>En tant que client adhérant</li><li>Je veux adhérer au Loyalty Program</li><li>Afin de bénéficier de 10% sur mes commandes</li></ul>| BecomeMember.feature | <ul><li>He wants to subscribe to the loyalty program</li></ul> |
| <ul><li>En tant que client</li><li>Je veux créer mon cookie personnalisé</li><li>Afin de choisir les quantités d’ingrédient</li></ul>| CreatePersonalizedRecipe.feature | <ul><li>Jhon create his recipe</li></ul> |
...
| <ul><li>En tant que client</li><li>Je veux choisir un cookie</li><li>Afin d'en modifier les ingrédients présents </li></ul>| CreatePersonalizedRecipe.feature | <ul><li>Jhon modify a cookie : adding an ingredient</li><li>Jhon modify a cookie : removing an ingredient</li><li>Jhon remove the ingredient called "chocolate"</li><li>Jhon modify a cookie : non valid</li></ul> |
