...
| <ul><li>En tant que client</li><li>Je veux créer mon cookie personnalisé</li><li>Afin de choisir les quantités d’ingrédient</li></ul>| <ul><li>CreatePersonalizedRecipe.feature</li><li>PayOrder.feature</li></ul> | <ul><li>A Client create his recipe</li><li>Order a personnalized cookie</li></ul> |
...
| <ul><li>En tant que client</li><li>Je veux choisir un cookie</li><li>Afin d'en modifier les ingrédients présents </li></ul>| CreatePersonalizedRecipe.feature | <ul><li>A Client modify a cookie : adding an ingredient</li><li>A Client modify a cookie : removing an ingredient</li><li>A Client modify a cookie : non valid</li></ul> |
